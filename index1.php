			  ...
			  <?php
                ...
                <div class="product">
                  <div class="flip-container">
                    <div class="flipper">
                      <div class="front"><a href="detail.html"><img src="../uploads/<?php echo $run['foto']; ?>" class="img-fluid"></a></div>
                      <div class="back"><a href="detail.html"><img src="../uploads/<?php echo $run['foto']; ?>" class="img-fluid"></a></div>
                    </div>
                  ...
                  <div class="text">
                    ...
                    <p class="price"> 
                      <!-- Group of default radios - option 1 -->
						...
						<div id="cart" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true" class="modal fade">
						  <div class="modal-dialog modal-sm">
							<div class="modal-content">
							  <div class="modal-header">
								<h5 class="modal-title">Customer login</h5>
