...
{
	$id=$_GET['id'];
	$data=mysqli_query($con,"select * from produk where id_produk='$id'");
            ...
            <div class="col-lg-12">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li aria-current="page" class="breadcrumb-item active"><?php  echo $run['nm_produk'];  ?></li>
                </ol>
              </nav>
            </div>
              ...
              <div class="card sidebar-menu mb-4">
                ...
                <div class="card-body">
                  <ul class="nav nav-pills flex-column category-menu">
                    <li><a href="category.html" class="nav-link">Perlengkapan Anak <span class="badge badge-secondary"></span></a>
                      <ul class="list-unstyled">
                        <li><a href="category.html" class="nav-link">Baju</a></li>
                      </ul>
                    </li>
                    <li><a href="category.html" class="nav-link">Mainan Anak<span class="badge badge-light"></span></a>
                      <ul class="list-unstyled">
              ...
              <div id="productMain" class="row">
                <div class="col-md-6">
                  <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                    <div class="item"> <img src="../uploads/<?php echo $run['foto']; ?>" alt="" class="img-fluid"></div>
                    <div class="item"> <img src="../uploads/<?php echo $run['foto']; ?>" alt="" class="img-fluid"></div>
                    <div class="item"> <img src="../uploads/<?php echo $run['foto']; ?>" alt="" class="img-fluid"></div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box">
                    <h1 class="text-center"><?php  echo $run['nm_produk'];  ?></h1>
					<div id="details" class="box">
                <p></p>
                <h4><?php  echo $run['deskripsi'];  ?></h4>
              </div>
					<form>
				...
				<div class="d-grid px py-2">
                  ...
                  <p><a href="#" class="external facebook"><i class="fa fa-facebook"></i></a>
